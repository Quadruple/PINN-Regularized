...
def build_lr(model, lr, tot_epoch, warm_up_steps, l2_lambda):
    optimizer_adam = torch.optim.Adam(model.parameters(), lr=lr, weight_decay=l2_lambda)
...
for l2_lambda in l2_lambdas:
    optimizer, scheduler = build_lr(ddp_g, lr, iteration, warm_up_steps, l2_lambda)
    for i in range(iteration):
        ...
        if (i+1) % test_step ==0:
            ...
            print("-"*10 + "BEGIN LAMBDA: " + str(l2_lambda) + " ITERATION: " + str(i + 1))
