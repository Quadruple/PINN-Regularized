...
for l1_lambda in l1_lambdas:
    for i in range(iteration):
        ...
        l1_norm = sum(p.abs().sum() for p in ddp_g.parameters())
        loss = domain_loss_constant * dloss + boundary_loss_constant * bloss + l1_lambda * l1_norm
        ...
        if (i+1) % test_step ==0:
            ...
            print("-"*10 + "BEGIN LAMBDA: " + str(l1_lambda) + " ITERATION: " + str(i + 1))
